...
departamento.setAttribute("class", "form-control");

var distrito = document.querySelector("#id_distrito");

distrito.setAttribute("class", "form-control");

var provincia = document.querySelector("#id_provincia");
